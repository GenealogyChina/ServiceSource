...
public class GsGetOldPasswordInDTO implements java.io.Serializable, Comparable<GsGetOldPasswordInDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsGetOldPasswordInDTO compareToDTO) {
