...
public class GsUpdateGenealogyInDTO implements java.io.Serializable, Comparable<GsUpdateGenealogyInDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsUpdateGenealogyInDTO compareToDTO) {
