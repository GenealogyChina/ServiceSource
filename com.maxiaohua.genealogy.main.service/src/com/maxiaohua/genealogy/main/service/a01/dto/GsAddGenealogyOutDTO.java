...
public class GsAddGenealogyOutDTO implements java.io.Serializable, Comparable<GsAddGenealogyOutDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsAddGenealogyOutDTO compareToDTO) {
