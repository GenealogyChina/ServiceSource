...
public class GsApplyJoinGenealogyInDTO implements java.io.Serializable, Comparable<GsApplyJoinGenealogyInDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsApplyJoinGenealogyInDTO compareToDTO) {
