...
public class GsSearchGenealogyOutDTO implements java.io.Serializable, Comparable<GsSearchGenealogyOutDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsSearchGenealogyOutDTO compareToDTO) {
