...
public class GsAddPersonalActionInDTO implements java.io.Serializable, Comparable<GsAddPersonalActionInDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsAddPersonalActionInDTO compareToDTO) {
