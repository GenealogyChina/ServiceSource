...
public class GsGetClansmanListInDTO implements java.io.Serializable, Comparable<GsGetClansmanListInDTO> {
	/**
	 * Serial ID
	 */
	 ...
	 */
	@Override
	public int compareTo(GsGetClansmanListInDTO compareToDTO) {
